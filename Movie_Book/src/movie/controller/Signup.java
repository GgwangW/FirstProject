...
public class Signup extends JFrame implements ActionListener{
	...
	public Signup() {
		...
		Font basicFnt = new Font("돋움",Font.BOLD,15);
		...
		idcheckBtn.setBackground(Color.blue);
		...
		//레이아웃
		setLayout(null);
		add(title).setBounds(310, 100, 200, 30);

		add(id).setBounds(200, 150, 100, 30);
		add(idField).setBounds(300, 150, 200, 30);
		add(idcheckBtn).setBounds(520, 150, 100, 30);

		add(name).setBounds(200, 200, 100, 30);
		add(nameField).setBounds(300,200,200,30);
		
		add(pwd).setBounds(200, 250, 100, 30);
		add(pwdField).setBounds(300, 250, 200, 30);

		add(pwdcheck).setBounds(200, 300, 100, 30);
		add(pwdcheckField).setBounds(300, 300, 200, 30);

		add(phone).setBounds(200, 350, 100, 30);
		add(phoneField).setBounds(300, 350, 200, 30);

		add(email).setBounds(200, 400, 100, 30);
		add(emailField).setBounds(300, 400, 200, 30);

		add(gender).setBounds(200, 450, 100, 30);
		add(genderComboBox).setBounds(300, 450, 50, 30);

		add(signupBtn).setBounds(300, 500, 100, 30);
		add(cancelBtn).setBounds(400, 500, 100, 30);
	} //생성자
	//이벤트 등록
	@Override
	public void actionPerformed(ActionEvent ae) {
			...
			if(btn.equals("회원가입")) {
				if(idField.getText().trim().equals("")) { 
					...
					userdto.setUser_id(idField.getText());
					userdto.setUser_name(nameField.getText());
					userdto.setUser_pwd(pwdField.getText());
